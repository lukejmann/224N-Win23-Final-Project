...
class SubjectClassifier(datasets.GeneratorBasedBuilder):
    ...
    def __init__(self, *args, writer_batch_size=None, subject="trump", **kwargs):
    ...
    def _split_generators(self, dl_manager):
        ...
        # load from local
        train_paths = [
            "dataset/trump_classifier/data/train/pos",
            "dataset/trump_classifier/data/train/neg",
        ]
        test_paths = [
            "dataset/trump_classifier/data/test/pos",
            "dataset/trump_classifier/data/test/neg",
        ]
